...
module LibertyBuildpack::Repository
  ...
  class VersionResolver
    ...
    def self.resolve(candidate_version, versions)
      ...
      tokenized_versions = versions.map { |version| print "version: #{version.to_s}" unless version.include?("License") }# LibertyBuildpack::Util::TokenizedVersion.new(version, false) }
