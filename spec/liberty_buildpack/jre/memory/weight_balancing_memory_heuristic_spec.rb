...
module LibertyBuildpack::Jre
  ...
  describe WeightBalancingMemoryHeuristic do
    ...
    before do
      ...
      File.delete(LibertyBuildpack::Diagnostics.get_buildpack_log Dir.tmpdir)
      LibertyBuildpack::Diagnostics::LoggerFactory.create_logger Dir.tmpdir
    end
    ...
    def buildpack_log_contents
      File.read(LibertyBuildpack::Diagnostics.get_buildpack_log(Dir.tmpdir))
    end
